    ...
    return Scaffold(
              ...
              return Row(
                children: [
                  IconButton(
                    ...
                    onPressed: () =>
                        _showGroupScheduleDialog(context, controller),
                  ),
                  IconButton(
      ...
      body: Obx(() {
        ...
        if (controller.customers.isEmpty && controller.searchQuery.isEmpty) {
          return const Center(
            child: Text('لا يوجد عملاء حالياً. قم بإضافة عميل جديد.'),
          );
        }
  ...
  void _confirmSendToGroup(
    ...
    Get.dialog(
      AlertDialog(
        ...
        content: Text(
          isGroup
              ? 'هل أنت متأكد من إرسال التذكير للعملاء المحددين فقط؟'
              : 'هل أنت متأكد من إرسال رسالة تذكير عبر الواتساب لجميع العملاء الذين عليهم ديون متبقية؟',
        ),
        actions: [
          ...
          ElevatedButton(
            ...
            child: Text(
              isGroup ? 'نعم، أرسل للمجموعة' : 'نعم، أرسل للكل',
            ...
            content: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'تكرار التذكير (كل كم يوم؟ اختياري)',
                  ),
